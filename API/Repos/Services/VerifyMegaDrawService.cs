...
{
    public class VerifyMegaDrawService : IJob
    {
        private readonly IServiceProvider _serviceProvider;

        public VerifyMegaDrawService(IServiceProvider serviceProvider)
        {
